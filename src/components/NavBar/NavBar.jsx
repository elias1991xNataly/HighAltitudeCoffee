	...
	return (<nav className='bg-custom-black text-white'>
		<div className='flex justify-between p-3'>
			<div className='flex p-3 gap-1 space-x-6 items-center'>
				<NavLink className="goHome flex position-relative  flex flex-row items-center" to="/"> <p className="goHome items-center flex position-relative gap-1.5 space-x-6">cafedealtura.com <b> <img src="./images/ps_coffee-hot.png" /></b></p></NavLink>
			</div>
